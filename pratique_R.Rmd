...
Pour savoir quelle méthode est actuellement utilisée pour l'option download.file.method dans R
```{r, eval = FALSE}
current_method <- getOption("download.file.method")
